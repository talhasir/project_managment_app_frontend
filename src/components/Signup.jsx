...
export default function Signup() {
  ...
  const [confPasswordRef, setConfPasswordRef] = useState();
  // States For Form input Data //
  ...
  const onSubmit = async (ev) => {
    ...
    const payload = {
      ...
      password_confirmation: confPasswordRef,
    };
    ...
    <>
      ...
      <Form
        ...
        >
          ...
          >
            <Input size="large" onChange={(e) => setFullNameRef(e.target.value)}/>
          </Form.Item>
          <Form.Item
          style={{marginBottom: '10px'}}
            label="Email"
          ...
          >
            <Input.Password size="large"  onChange={(e) => setConfPasswordRef(e.target.value)}/>
          </Form.Item>
